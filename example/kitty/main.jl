...
function main()
    ...
    meshscatter!(
        ...
        color=:gray, markersize=0.02, quality=8,
    )
    ...
    for i in 1:length(slam_positions)
        ...
        xlims!(visualizer.pc_axis, (-10 + camera_pos[1], 10 + camera_pos[1]))
        ylims!(visualizer.pc_axis, (-10 + camera_pos[2], 10 + camera_pos[2]))
    ...
    xlims!(visualizer.pc_axis, (-10, 150))
    ylims!(visualizer.pc_axis, (2, 150))
