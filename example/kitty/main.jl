...
function main()
    ...
    for i in 1:length(dataset)
        ...
        position = Point3f0(
            (slam_manager.current_frame.wc * base_position)[1:3]
        )
    ...
    # meshscatter!(visualizer.pc_axis, slam_mappoints; color=:black, markersize=0.1, quality=8)
